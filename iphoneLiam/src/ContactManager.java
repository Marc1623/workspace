 ...
 * @Version: 1.0
 * Created: 31.05.2015 - Last Update: 07.06.2015
 * Class ContactManager to manage contact data
 *
 */
...
public class ContactManager implements Serializable {
    ...
    public ContactManager(String firstname, String name, String email, String phone, String address, String zipcity, String comment) {
        super();
