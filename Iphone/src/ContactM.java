...
public class ContactM implements Serializable {
    ...
    public ContactM(String firstname, String name, String email, String phone, String address, String zipcity, String photo) {
        super();
     ...
     *
     * Setter for photo
     * @return value of photo to set / overwrite
     *
     */
